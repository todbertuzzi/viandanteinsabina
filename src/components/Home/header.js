    ...
    <Fade duration={2200}>
      ...
      >
        ...
        <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 drop-shadow">
          ...
          <a target="_blank" href="https://www.airbnb.it/rooms/1196884562594764074?search_mode=regular_search&source_impression_id=p3_1721296761_P3pdOAHDVkrELfF3&previous_page_section_name=1000&federated_search_id=02a0b523-b89b-4da5-9a17-8624caaa0270">
            <button type="button" className="mr-2 text-gray-900 airbnb_book focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600  me-2 mb-2">
          ...
          <button type="button" className="ml-2 text-gray-900  booking_book  focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 0   me-2 mb-2">
